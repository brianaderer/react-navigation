...
export { type StaticNavigation, type StaticParamList, type StaticScreenProps, createComponentForStaticNavigation, createPathConfigForStaticNavigation, } from './StaticNavigation';
export * from './types';
