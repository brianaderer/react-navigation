...
function useNavigationBuilder(createRouter, options) {
  ...
  const NavigationContent = (0, _useComponent.useComponent)(children => /*#__PURE__*/React.createElement(_NavigationHelpersContext.NavigationHelpersContext.Provider, {
    value: navigation
  }, /*#__PURE__*/React.createElement(_PreventRemoveProvider.PreventRemoveProvider, null, children)));
  return {
    state,
    navigation,
    descriptors,
