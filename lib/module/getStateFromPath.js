...
export function getStateFromPath(path, options) {
  ...
  const prefix = options === null || options === void 0 ? void 0 : (_options$path = options.path) === null || _options$path === void 0 ? void 0 : _options$path.replace(/^\//, ''); // Remove extra leading slash
